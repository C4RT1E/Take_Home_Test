          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <div className="flex flex-col justify-start">
              <label className="text-[11px] font-medium text-slate-400 mb-1 flex items-center gap-1">
                <Calendar className="w-3 h-3 text-indigo-400" /> Edit Deadline:
              </label>
              <input
                type="datetime-local"
                value={editDueDate}
                ...
                disabled={isSaving}
                className="w-full px-3 py-1.5 rounded-xl bg-slate-950/80 border border-slate-800 text-slate-200 text-xs outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20"
              />
            </div>
          </div>
